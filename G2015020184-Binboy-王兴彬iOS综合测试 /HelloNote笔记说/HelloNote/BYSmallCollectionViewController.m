...
@interface BYSmallCollectionViewController ()
...
@implementation BYSmallCollectionViewController
...
- (void)viewDidLoad
{
    ...
    _topImage = [[UIImageView alloc] initWithFrame:[UIScreen mainScreen].bounds];
    ...
    subTitle.text = @"It's You Note , Also Is Our ";
